...
const Aspects = ({ id, onComplete }) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      console.log("Aspects submitted successfully:", aspectResponse);
    } catch (error) {
...
// Loading screen for scoring agent initialization
if (loadingApplicants) {
  return (
    <>
      
      <div className="aspects_loading_container_Applicants">
      <div className="aspects_loading_heading">
        Preparing the scoring agent to evaluate the profiles...
      </div>
      ...
      <p className="aspects_loading_side">This may take a while</p>
      <p className="aspects_loading_sub">please wait for a second</p>
      </div>
    </>
  );
}
